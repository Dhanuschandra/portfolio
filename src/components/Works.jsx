    ...
    <>
      ...
      <div className="w-full flex">
        <p className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">
          Following Projects demonstrate my proficiency in AI, web development, and full-stack technologies. Each includes a description, GitHub link, and live demo to showcase functionality and problem-solving.
        </p>
      </div>
